...
PROJECTID=$(curl -s "http://metadata.google.internal/computeMetadata/v1/project/prototype-content-consumer" -H "Metadata-Flavor: Google")
...
git clone https://source.developers.google.com/p/$GCLOUD_PROJECT /opt/app
